...
{    
    ...
    // conv1 output
    ifstream ifs_conv1("../binNew/conv1.bin", ios::in | ios::binary);
    ifs_conv1.read((char*)(**output_conv1), 1*32*187*sizeof(float));
    ifs_conv1.close();

    // conv2 output
    ifstream ifs_conv2("../binNew/conv2.bin", ios::in | ios::binary);
    ifs_conv2.read((char*)(**output_conv2), 1*32*92*sizeof(float));
    ifs_conv2.close();

    // max1 output
    ifstream ifs_max1("../binNew/max1.bin", ios::in | ios::binary);
    ifs_max1.read((char*)(**output_max1), 1*32*92*sizeof(float));
    ifs_max1.close();

    // max2 output
    ifstream ifs_max2("../binNew/max2.bin", ios::in | ios::binary);
    ifs_max2.read((char*)(**output_max2), 1*32*44*sizeof(float));
    ifs_max2.close();

    //conv3 output
    ifstream ifs_conv3("../binNew/conv3.bin", ios::in | ios::binary);
    ifs_conv3.read((char*)(**output_conv3), 1*32*44*sizeof(float));
    ifs_conv3.close();

    //conv4 output
    ifstream ifs_conv4("../binNew/conv4.bin", ios::in | ios::binary);
    ifs_conv4.read((char*)(**output_conv4), 1*32*20*sizeof(float));
    ifs_conv4.close();


        // max3 output
    ifstream ifs_max3("../binNew/max3.bin", ios::in | ios::binary);
    ifs_max3.read((char*)(**output_max3), 1*32*20*sizeof(float));
    ifs_max3.close();

        // max4 output
    ifstream ifs_max4("../binNew/max4.bin", ios::in | ios::binary);
    ifs_max4.read((char*)(**output_max4), 1*32*8*sizeof(float));
    ifs_max4.close();

           // max5 output
    ifstream ifs_max5("../binNew/max5.bin", ios::in | ios::binary);
    ifs_max5.read((char*)(**output_max5), 1*32*2*sizeof(float));
    ifs_max5.close();

      //Final output
    ifstream ifs_dense2("../binNew/dense2.bin", ios::in | ios::binary);
    ...
    // Weights 1
    ifstream ifs_conv1_weights("../binNew/conv1_weights.bin", ios::in | ios::binary);
    ...
    // Bias 1
    ifstream ifs_conv1_bias("../binNew/conv1_bias.bin", ios::in | ios::binary);
    ...
    // Weights 2
    ifstream ifs_conv2_weights("../binNew/conv2_weights.bin", ios::in | ios::binary);
    ...
    // Bias 2
    ifstream ifs_conv2_bias("../binNew/conv2_bias.bin", ios::in | ios::binary);
    ...
    // Weights 3
    ifstream ifs_conv3_weights("../binNew/conv3_weights.bin", ios::in | ios::binary);
    ...
    // Bias 3
    ifstream ifs_conv3_bias("../binNew/conv3_bias.bin", ios::in | ios::binary);
    ...
    // Weights 4
    ifstream ifs_conv4_weights("../binNew/conv4_weights.bin", ios::in | ios::binary);
    ...
    // Bias 4
    ifstream ifs_conv4_bias("../binNew/conv4_bias.bin", ios::in | ios::binary);
    ...
    ifstream ifs_dense1_bias("../binNew/dense1_bias.bin", ios::in | ios::binary);
    ...
    ifstream ifs_dense2_bias("../binNew/dense2_bias.bin", ios::in | ios::binary);
    ...
    ifstream ifs_dense1_weights("../binNew/dense1_weights.bin", ios::in | ios::binary);
    ...
    ifstream ifs_dense2_weights("../binNew/dense2_weights.bin", ios::in | ios::binary);
