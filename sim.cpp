...
void read_bin_files()
{
    ...
    // Bias
    ifstream ifs_conv_bias("conv1_bias.bin", ios::in | ios::binary);
    ...
    ifstream ifs_conv_input2("conv2.bin", ios::in | ios::binary);
